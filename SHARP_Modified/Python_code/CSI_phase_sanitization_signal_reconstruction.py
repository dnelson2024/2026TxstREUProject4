...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', help='Process only this single Tr file (base name, no .txt). '
                                       'Default: process every Tr*.txt in dir.', default=None)
    ...
    for name in names:
        ...
        # makedirs(exist_ok=True) is race-safe when many array tasks write the
        # same subdir concurrently (plain mkdir would raise FileExistsError).
